const FLHistory = require("../models/FLHistory.js");

// const FLStatusRead = async (req,res) => {
//     try {
...
// const FLStatusWrite = async (req,res) => {
//     try {
//         const addr = req.body.arenaAddress;
...
const FLHistoryRead = async (req,res) => {
    try {
...
const FLHistoryWrite = async (req,res) => {
    try {
        const addr = req.body.address;
        const date = req.body.date;
        const token = req.body.token;
