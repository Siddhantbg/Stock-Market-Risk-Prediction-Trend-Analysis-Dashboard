const MoneyTransfer = require('../models/MoneyTransfer.js');
const User = require('../models/User.js');
const BankDetails = require('../models/bank.js');
const requestMoney = require('../models/requestMoney.js');
...
const getMoneyTransfers = async (req, res) => {
  try {
...
const allRequestMoney = async(req, res, next) =>{
  try {
    const userId = req.user.id;
